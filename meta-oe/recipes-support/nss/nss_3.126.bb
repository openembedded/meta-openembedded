...
LICENSE = "GPL-2.0-or-later AND MIT AND MPL-2.0 OR LGPL-2.1-or-later AND MIT AND MPL-2.0 OR MIT AND MPL-2.0"
...
SRC_URI = "https://ftp.mozilla.org/pub/security/nss/releases/${VERSION_DIR}/src/${BP}.tar.gz \
           ...
           "
SRC_URI[sha256sum] = "7aa07c758be1453d82d739240b249ffb7aef0041be488067e1c0f348e1f9e337"
